...
import uagrm.androideatit.Watson.Conversation.ChatBotActivity;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_home);
        ...
        {
            Toast.makeText(Home.this,"verifique su conexion a internet",Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            //Eliminar Recordar usuario y password
            Paper.book().destroy();
